...
%The paper compares CSMA/ECA and CSMA/CA with and without the Request-To-Send/Clear-To-Send (RTS/CTS) four-way handshake.
...
This approach does not work well with CSMA/CA when collisions occur, as ARF misinterprets the failures as channel errors and reduces the transmission rate.
This problem can be alleviated by using RTS/CTS that can differentiate between collisions and channel errors, but RTS/CTS penalizes the performance due to the overheads additional.
