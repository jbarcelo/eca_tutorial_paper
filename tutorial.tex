...
Finally, simulation results confirm the advantages of the use of a deterministic backoff after successful transmsissions.
\end{abstract}
...
In doing so, it decreases the chances of collisions and, under the assumption of fixed packet size equal to the above mentioned fixed length slot, it doubles the throughput of the original Aloha.
...
The interaction between CSMA/CA and ARF is very problematic.
ARF lowers the transmission rate after unsuccessful transmissions.
The original goal of ARF is to use more robust modulations in the 
