...
\begin{abstract}
%\boldmath
In wireless local area networks (WLANs), a media access protocol arbitrates the access to
In current IEEE 802.11 WLANs, carrier sense multiple access with collision avoidance (CSM
Carrier sense multiple access with enhanced collision avoidance (CSMA/ECA) is a subtle va
CSMA/ECA significantly reduces the collision probability and, under certain conditions, l
The only difference between CSMA/CA and CSMA/ECA is that the latter uses a deterministic 
This deterministic backoff is a constant and is the same for all the stations.

The first part of the paper is of tutorial nature, offering an introduction to the basic 
The second part of the paper surveys related contributions, briefly summarizing the main 
