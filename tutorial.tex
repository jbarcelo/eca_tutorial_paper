...
Carrier sense multiple access with enhanced collision avoidance (CSMA/ECA) is a subtle variant of the well-known CSMA/CA algorithm in which the number of collisions is initially reduced before the different stations construct a collision-free schedule.
