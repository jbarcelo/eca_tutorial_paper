...
Carrier sense multiple access with enhanced collision avoidance (CSMA/ECA) is a subtle variant of the well-known CSMA/CA algorithm in which the \DIFaddbegin \DIFadd{number of collisions is initially reduced before the }\DIFaddend different stations construct a collision-free schedule.
